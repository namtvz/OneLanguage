class @ChattingHelper
    ...
    if m.sender_id is @user.id
      ...
      if m.original_role is 'owner'
        tr.find('td.partner-td').append('
          <div class="message-content"><div class="arrow"></div>' + m.message + '</div> <div class="message-time">' + m.message_ref + '</div>
        ')
      else
      ...
      if m.sender_role is 'owner'
        ...
        tr.append('<td class="owner-td"><div class="message-content"><div class="arrow"></div>' + m.message + '</div> <div class="message-time">' + m.message_ref + '</div></td><td class="translator-td"><div class="message-content"><div class="arrow"></div><textarea class="translate-input" o_role="' + m.sender_role + '"u_id="' + m.sender_id + '" m_ref="' + m.message_ref + '"placeholder="Enter translated text ..."></textarea></div></td><td class="partner-td"></td>
        ')
      else
        tr.addClass 'from-partner'
        tr.append('<td class="owner-td"></td><td class="translator-td"><div class="message-content"><div class="arrow"></div><textarea class="translate-input" o_role="' + m.sender_role + '"u_id="' + m.sender_id + '"m_ref="' + m.message_ref + '"placeholder="Enter translated text ..."></textarea></div></td><td class="partner-td"><div class="message-content"><div class="arrow"></div>' + m.message + '</div> <div class="message-time">' + m.message_ref + '</div></td>
        ')
  ...
  showMessageForPartner: (m) ->
    if $('tr#' + m.message_ref).length > 0
      ...
      if m.sender_id is @user.id
        tr.addClass 'from-owner'
        tr.append('<td class="owner-td"><div class="message-content"><div class="arrow"></div>' + m.message + '</div> <div class="message-time">' + m.message_ref + '</div></td><td class="translator-td"></td><td class="partner-td"></td>
        ')
      else
        tr.addClass 'from-partner'
        tr.append('<td class="owner-td"></td><td class="translator-td"></td><td class="partner-td"><div class="message-content"><div class="arrow"></div>' + m.message + '</div> <div class="message-time">' + m.message_ref + '</div></td>
        ')
      @chattingTable.append(tr)
